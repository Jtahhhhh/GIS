				...
				<div class="container">
					<div class="row">
						<div class="col-lg-8 posts-list">
							<?php
								$khid = $_SESSION["id"];
								$sql = "select cx.CX_MA, cx.CX_NOIDEN, cx.CX_trangThai, kh.KH_TEN, tx.TX_TEN
													from chuyen_xe cx
                          ...
                          order by cx.CX_MA desc";
							...
							<div class="single-post row">
								...
								<div class="col-lg-9 col-md-9 ">
									...
									<!-- <a class="posts-title" href="blog-single.html"><h4><?php echo $row["DG_NOIDUNG"] ?></h4></a> -->
									<!-- <p class="excert">
						...
						<div class="col-lg-4 sidebar-widgets">
							<div class="widget-wrap">
								...
								<div class="single-sidebar-widget post-category-widget">
									<h4 class="category-title">Điểm tích lũy của bạn</h4>
									<ul class="cat-list">
										<li>
											<?php
												require 'connect.php';
												$idkh = $_SESSION["id"];
												$sql_dtl = "select * from khach_hang where kh_ma = {$khid}";
												$result = $conn->query($sql_dtl);
